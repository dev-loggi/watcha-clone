...
import kotlinx.android.synthetic.main.fragment_transition_test1.*

class TransitionTestFragment1 : Fragment() {

    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?, savedInstanceState: Bundle?
    ): View? = inflater.inflate(R.layout.fragment_transition_test1, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener {
            ...
            with(activity as TransitionTestActivity) {
                changeFragment(
                    this@TransitionTestFragment1,
                    TransitionTestFragment2(),
